...
class AppColor {
  ...
  static const Color specialist = Color(0xFF03a89e);
  static const Color expert = Color(0xFF0000ff);
  static const Color candidateMaster = Color(0xFFaa00aa);
  static const Color master = Color(0xFFff8c00);
  static const Color internationalMaster = Color(0xFFff8c00);
  static const Color grandmaster = Color(0xFFff0000);
