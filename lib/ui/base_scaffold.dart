...
class _BaseScaffoldState extends State<BaseScaffold> {
  ...
  static const List<int> lengths = [4, 0, 0, 0];
  ...
  static List<List<Tab>> tabs = [
    homePageTabs, [], [], []
  ];
  @override
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: lengths[_index],
      child: Scaffold(
        appBar: const MyAppBar(),
        body: body[_index],

        bottomNavigationBar: lengths[_index] == 0 ? null : Material(
